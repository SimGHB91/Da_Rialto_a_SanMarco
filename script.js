document.addEventListener('DOMContentLoaded', function() {
    ...
    var map = L.map('map').setView([45.43612, 12.337174], 14);
    ...
    var southWest = L.latLng(45.434328, 12.333548),
        northEast = L.latLng(45.437302, 12.340457);
    ...
    markers.push(L.marker([45.436602, 12.334047], {
        icon: selectedIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.436289, 12.33512], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.435909, 12.335243], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.435156, 12.336874], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.435875, 12.339953], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.434833, 12.338848], {
        icon: defaultIcon
    }).addTo(map));
